...
" Работает для NeoVim 0.4. Без компиляции,
...
if has('nvim')
    ...
    " В NeoVim, Alt - клавиша модификатор, так же, как и кнопка Windows,
    " поэтому она пишется в командах, как <M>
...
" Перемещение к предыдущей/следующей вкладке по нажатию Ctlr+Alt+Влево/Вправо
...
"
" also, use <C-...> instead of  and similar
"
" GruvBox, поддерживаемая сообществом:
